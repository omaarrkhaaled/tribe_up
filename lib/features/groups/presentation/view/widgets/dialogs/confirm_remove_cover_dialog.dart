...
class ConfirmRemoveCoverDialog extends StatelessWidget {
  final Group tribe;
  final TribeSettingsCubit cubit;
  const ConfirmRemoveCoverDialog({
    super.key,
    required this.tribe,
    required this.cubit,
  });
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              UiConstants.confirmRemoveCover,
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      cubit.doIntent(DeleteTribePictureIntent(tribe.id!));
                    },
                    child: Text(
                      UiConstants.remove,
                      style: textTheme.bodyMedium?.copyWith(
