...
class GetInvitationDetailsUseCase {
  ...
  GetInvitationDetailsUseCase(this.repository);

  Future<BaseResponse<InvitationDetailsDTO>> call(String token) async {
    return await repository.getInvitationDetails(token);
  }
}
